"""Load the 2026 match subset and the full shootout history into RAW, and
record one AUDIT.LOAD_LOG row per file loaded.
...
from config import MATCH_SOURCE_PATH, SHOOTOUT_SOURCE_PATH, load_snowflake_config
